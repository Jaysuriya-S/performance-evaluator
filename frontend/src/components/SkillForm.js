  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        'http://127.0.0.1:8000/auth/submit-skill/',  // Update the URL to your backend route
        formData,
        {
          headers: {
            'Content-Type': 'application/json'  // Important: tell backend we are sending JSON
          }
        }
      );
  ...
  return (
    <>
      ...
      <div className="navbar">
        <div className="logo">⚙️ SkillSight</div>
        <ul>
          <li><a href="/">Home</a></li>
